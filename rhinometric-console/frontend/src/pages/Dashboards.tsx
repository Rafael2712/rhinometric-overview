      ...
      {dashboard.tags.length > 0 && (
        <div className="flex flex-wrap gap-2 mt-3">
          {dashboard.tags.slice(0, 3).map((tag, index) => (
            <span
              key={index}
              className="inline-flex items-center gap-1 px-2 py-1 bg-gray-50 rounded text-xs text-text-secondary"
            >
          ...
          {dashboard.tags.length > 3 && (
            <span className="inline-flex items-center px-2 py-1 bg-gray-50 rounded text-xs text-text-muted">
      ...
      {selectedDashboards.length === 0 && (
        <div className="card text-center py-16 space-y-4">
          <div className="flex justify-center">
            <div className="w-16 h-16 rounded-full bg-gray-50/50 flex items-center justify-center">
              <Globe className="w-8 h-8 text-text-muted" />
            </div>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900">No dashboards selected</h3>
