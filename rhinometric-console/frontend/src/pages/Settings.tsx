...
export function SettingsPage() {
  ...
  const inputClass = "w-full bg-gray-50 border border-border rounded-lg px-3 py-2 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent placeholder-gray-500"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">Configure your Rhinometric Console preferences and notification channels</p>
      </div>
      ...
      <div className="card">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">AI Anomaly Alerting</h3>
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-gray-900 font-medium">Enable AI Alerting</span>
          ...
          <button
            ...
            className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
              aiAlertsEnabled ? 'bg-success' : 'bg-gray-300'
      ...
      <div className="card">
        ...
        {/* ---- SLACK ---- */}
        <div className="mb-8 p-5 bg-gray-50 rounded-lg border border-border">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <MessageSquare className="text-purple-400" size={20} />
              <h4 className="text-gray-900 font-semibold">Slack</h4>
              <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                slackStatus === 'configured' ? 'bg-success/20 text-success' : 'bg-gray-100 text-gray-500'
              }`}>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                slackEnabled ? 'bg-purple-500' : 'bg-gray-300'
              }`}
            >
        ...
        <div className="mb-6 p-5 bg-gray-50 rounded-lg border border-border">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-gray-900 font-semibold">Email (SMTP)</h4>
              <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                emailStatus === 'configured' ? 'bg-success/20 text-success' : 'bg-gray-100 text-gray-500'
              }`}>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                emailEnabled ? 'bg-cyan-500' : 'bg-gray-300'
              }`}
            >
              <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <button onClick={() => setShowSmtpPassword(!showSmtpPassword)} className="absolute right-3 top-2.5 text-gray-500 hover:text-gray-600">
              ...
              <div className="flex items-center gap-3 pt-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={smtpTls} onChange={e => setSmtpTls(e.target.checked)}
                    className="w-4 h-4 rounded border-gray-200 text-primary focus:ring-primary bg-gray-50" />
                  <span className="text-sm text-gray-600">Require STARTTLS</span>
                </label>
              </div>
