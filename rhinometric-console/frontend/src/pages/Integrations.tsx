      ...
      <div className="card max-w-3xl mx-auto text-center py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto text-left">
          <div className="bg-gray-50 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2">REST APIs</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2">MQTT Brokers</h3>
            <p className="text-sm text-text-muted">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2">Custom Collectors</h3>
            <p className="text-sm text-text-muted">
