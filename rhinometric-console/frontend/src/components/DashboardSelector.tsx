        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-surface-light">
              <div>
                <h2 className="text-lg font-bold text-gray-900">Dashboard Library</h2>
                <p className="text-text-muted text-sm mt-0.5">Select dashboards to display</p>
              </div>
              <button onClick={() => setOpen(false)} className="text-text-muted hover:text-gray-900 transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            {/* Footer */}
            <div className="flex items-center justify-between px-6 py-4 border-t border-surface-light bg-gray-50/30">
  ...
  <button
    ...
    className={`w-full flex items-start gap-3 p-3 rounded-lg border transition-all text-left ${
      active
        ...
        : 'border-surface-light bg-transparent hover:bg-gray-50/30'
    }`}
  >
    {/* Checkbox */}
    <div
      className={`mt-0.5 w-5 h-5 rounded flex-shrink-0 flex items-center justify-center border transition-colors ${
        active
          ...
          : 'border-surface-light bg-gray-50/50'
      }`}
    >
