...
import { Home, LayoutDashboard, AlertTriangle, Bell, FileText, Network, CreditCard, Settings, LogOut, Menu, X, Users, Map, Globe, Brain, ClipboardList, Flame, Target, Shield, Share2, HardDrive, BarChart3, Microscope } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'AI Anomalies V2', href: '/ai-anomalies-v2', icon: Microscope },
