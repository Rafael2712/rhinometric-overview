...
def setup_tracing(service_name: str):
    ...
    Returns: (tracer, fastapi_instrumentor) tuple
    """
    ...
    # Return tracer and FastAPI instrumentor for manual instrumentation
    return trace.get_tracer(__name__), FastAPIInstrumentor()
