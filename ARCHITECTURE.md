...
graph TB
    ...
    subgraph Intelligence Layer
        AI[AI Anomaly Detector<br/>IsolationForest]
...
| 4 | postgres | PostgreSQL 15 | 5432 | Primary database for all application state |
...
| 9 | jaeger | Jaeger | 16686 | Distributed trace collection and query |
...
| 12 | otel-collector | OpenTelemetry Collector | 4317, 4318 | Telemetry pipeline (traces, metrics) |
| 13 | node-exporter | Prometheus Node Exporter | 9100 | Host-level metrics (CPU, memory, disk, network) |
...
| 19 | ai-anomaly | Custom Python | 8110 | AI anomaly detection engine |
...
| AI Detector | Horizontal — shard by service groups |
