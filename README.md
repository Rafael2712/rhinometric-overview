...
**Licencia Trial**: 30 días automáticos desde instalación
...
### Guías Bilingües (Español/English)
- [📘 Guía Técnica para Conectar Aplicaciones](docs/USER_GUIDE_CONNECT_APPS.md) - DevOps, Integradores, Administradores IT
- [📗 Guía Institucional Sector Público](docs/GUIDE_PUBLIC_SECTOR.md) - Ayuntamientos, Empresas Públicas, Instituciones
...
- ✅ **Trial**: 30 días uso completo sin restricciones
