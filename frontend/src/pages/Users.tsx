...
const ROLE_META: Record<string, { label: string; desc: string; color: string; bg: string; icon: any }> = {
  OWNER:    { label: 'Owner',    desc: 'License holder with full platform control',  color: 'text-amber-700',  bg: 'bg-white border-amber-200',      icon: Crown },
  ADMIN:    { label: 'Admin',    desc: 'Operational administrator',                  color: 'text-indigo-700', bg: 'bg-white border-indigo-200',      icon: Shield },
  OPERATOR: { label: 'Operator', desc: 'Handles monitoring, alerts, incidents',      color: 'text-emerald-700',bg: 'bg-white border-emerald-200',     icon: Wrench },
  VIEWER:   { label: 'Viewer',   desc: 'Read-only access',                           color: 'text-slate-600',  bg: 'bg-white border-slate-200',       icon: BookOpen },
}
