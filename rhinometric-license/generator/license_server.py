import logging
logging.basicConfig(filename='/app/logs/license.log', level=logging.INFO)
...
os.makedirs('/data/logs', exist_ok=True)  # Para logs
...
def generate_license():
    data = request.json
    logging.info(f"Generated license for {data}")
