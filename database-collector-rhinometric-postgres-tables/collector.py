...
SERVICE_NAME = os.getenv("SERVICE_NAME", "database-collector-default")
...
DB_USER = "rhinometric"
DB_PASSWORD = "rhinometric_demo"
QUERY_SQL = """SELECT COUNT(*) as total_tables FROM information_schema.tables WHERE table_schema = 'public'"""
METRICS_PORT = 9333
QUERY_INTERVAL = 120
