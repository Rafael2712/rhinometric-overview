...
QUERY_SQL = os.getenv("QUERY_SQL", """SELECT pg_database_size('rhinometric') as size_bytes""")
METRICS_PORT = int(os.getenv("METRICS_PORT", "9337"))
QUERY_INTERVAL = int(os.getenv("QUERY_INTERVAL", "30"))
