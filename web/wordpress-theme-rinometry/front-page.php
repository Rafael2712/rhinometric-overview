...
$t = [
    ...
    'depsec_1'      => ['en' => 'Deploy on-premise or in a dedicated VM within a European cloud provider, under full customer control. Ideal for regulated and data-sensitive environments where observability must remain under your control.', 'es' => 'Despliega on-premise o en una VM dedicada dentro de un proveedor cloud europeo, bajo control total del cliente. Ideal para entornos regulados y sensibles donde la observabilidad debe permanecer bajo tu control.'],
