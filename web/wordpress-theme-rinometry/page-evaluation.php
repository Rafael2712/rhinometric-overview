...
$t = [
    ...
    'covers_1'    => ['en' => 'Deployment model discussion (on-premise or dedicated VM in a European cloud provider)', 'es' => 'Discusión del modelo de despliegue (on-premise o VM dedicada en un proveedor cloud europeo)'],
    'covers_2'    => ['en' => 'Architecture walkthrough (Prometheus + VictoriaMetrics, Loki, Jaeger, Grafana, Alertmanager)', 'es' => 'Recorrido arquitectónico (Prometheus + VictoriaMetrics, Loki, Jaeger, Grafana, Alertmanager)'],
