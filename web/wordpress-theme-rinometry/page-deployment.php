...
$t = [
    ...
    'ps_d'    => ['en' => 'A dedicated virtual machine per customer within a European public cloud environment. No shared resources, no multi-tenancy.', 'es' => 'Una máquina virtual dedicada por cliente dentro de un entorno de nube pública europeo. Sin recursos compartidos, sin multi-tenancy.'],
    'ps_f1'   => ['en' => 'Dedicated VM — no shared resources', 'es' => 'VM dedicada — sin recursos compartidos'],
    'ps_f2'   => ['en' => 'European public cloud environment', 'es' => 'Entorno de nube pública europeo'],
