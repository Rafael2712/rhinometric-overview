...
<section class="section">
  <div class="container">
    ...
    <p class="section-lead"><?php esc_html_e('Security is built into Rhinometric—from access controls to hardened deployments. We never claim certifications we do not hold.', 'rinometry'); ?></p>
    <div class="grid">
      <div class="card">
