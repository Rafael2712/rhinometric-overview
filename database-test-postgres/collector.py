"""
RHINOMETRIC v2.5.0 - Database Collector
========================================

Database collector for PostgreSQL monitoring
"""
...
resource = Resource.create({
    "service.name": "database-collector-postgres-test",
...
QUERY_SQL = "SELECT COUNT(*) as table_count FROM information_schema.tables WHERE table_schema='public';"
METRICS_PORT = 9351
QUERY_INTERVAL = 30
...
def create_db_engine():
    ...
    SQLAlchemyInstrumentor().instrument(
        engine=engine,
        service=f"database-collector-postgres-test"
    )
