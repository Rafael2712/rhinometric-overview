...
QUERY_SQL = os.getenv("QUERY_SQL", """SELECT EXTRACT(EPOCH FROM (now() - pg_last_xact_replay_timestamp())) AS lag_seconds""")
METRICS_PORT = int(os.getenv("METRICS_PORT", "9343"))
QUERY_INTERVAL = int(os.getenv("QUERY_INTERVAL", "29"))
