...
QUERY_SQL = os.getenv("QUERY_SQL", """SELECT COUNT(*) as slow_queries FROM pg_stat_activity WHERE state = 'active' AND query_start < NOW() - INTERVAL '5 seconds'""")
METRICS_PORT = int(os.getenv("METRICS_PORT", "9346"))
QUERY_INTERVAL = int(os.getenv("QUERY_INTERVAL", "15"))
