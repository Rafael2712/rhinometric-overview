...
QUERY_SQL = os.getenv("QUERY_SQL", """SELECT COUNT(*) as total_connections FROM pg_stat_activity WHERE datname IS NOT NULL""")
METRICS_PORT = int(os.getenv("METRICS_PORT", "9347"))
QUERY_INTERVAL = int(os.getenv("QUERY_INTERVAL", "20"))
